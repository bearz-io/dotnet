    ...
    where TKey : notnull
{
    ...
    public sealed class OrderedValueCollection : ICollection<TValue>, IReadOnlyCollection<TValue>
    {
        private readonly OrderedDictionary<TKey, TValue> dictionary;
    ...
    public sealed class OrderedKeyCollection : ICollection<TKey>, IReadOnlyCollection<TKey>
    {
        private readonly OrderedDictionary<TKey, TValue> dictionary;
